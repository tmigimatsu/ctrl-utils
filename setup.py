...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        subprocess.check_call(['cmake', '-DBUILD_TESTING=OFF', '-DBUILD_CPP=OFF', '..'],
                              cwd=build_dir)
...
setup(
    name="ctrlutils",
    version="1.2.0",
    description="Python wrapper for the C++ ctrl_utils library",
    url="https://github.com/tmigimatsu/ctrl-utils.git",
    author="Toki Migimatsu",
    license="MIT",
    # ext_modules=[CMakeExtension('ctrl-utils')],
